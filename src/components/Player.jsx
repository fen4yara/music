  ...
  return (
    <div className='h-[10%] bg-black flex justify-between items-center text-white px-4'>
        ...
        <div className="hidden lg:flex items-center gap-2 opacity-75">
            <img src={assets.play_icon} alt="icom" className="w-4" />
            <img src={assets.mic_icon} alt="icom" className="w-4" />
            <img src={assets.queue_icon} alt="icom" className="w-4" />
            <img src={assets.speaker_icon} alt="icom" className="w-4" />
            <img src={assets.volume_icon} alt="icom" className="w-4" />
            <div className="w-20 bg-slate-50 h-1 rounded"></div>
            <img src={assets.mini_player_icon} alt="icom" className="w-4" />
            <img src={assets.zoom_icon} alt="icom" className="w-4" />
        </div>
    </div>
  )
}
